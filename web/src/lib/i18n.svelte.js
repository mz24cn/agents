...
const translations = {
  zh: {
    ...
    updateAvailableButBusy: '检测到新版本，但当前存在推理中的会话',
    updateAvailable: '检测到可用更新：{version}',
  ...
  en: {
    ...
    updateAvailableButBusy: 'An update is available, but an inference session is active',

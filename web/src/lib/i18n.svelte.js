...
const translations = {
  zh: {
    ...
    updateAvailableButBusy: '检测到可同步项目，但当前存在推理中的会话',
    ...
    downgradeAvailableButBusy: '检测到可还原项目，但当前存在推理中的会话',
    ...
    updateInferenceActive: '当前存在推理中的会话，无法更新',
  ...
  en: {
    ...
    updateVersionSeparator: ', ',
    updateAvailableButBusy: 'Items can be synchronized, but an inference session is active',
    ...
    downgradeAvailableButBusy: 'Items can be restored, but an inference session is active',
    ...
    updateInferenceActive: 'Cannot update while an inference session is active',

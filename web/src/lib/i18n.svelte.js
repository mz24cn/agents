...
const translations = {
  zh: {
    ...
    updateAvailableButBusy: '检测到可用更新：{versions}；但当前存在推理中的会话',
    updateAvailable: '检测到可用更新：{versions}',
  ...
  en: {
    ...
    updateVersionSeparator: ', ',
    updateAvailableButBusy: 'Updates available: {versions}; an inference session is active',
    updateAvailable: 'Updates available: {versions}',
